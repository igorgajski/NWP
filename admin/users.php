	...
	#Edit user profile
		...
		<h2>Uredi profil</h2>
			...
			<form action="" id="registration_form" name="registration_form" method="POST">
				...
				<label for="lname">Prezime *</label></div>
				<br/>
				...
				<br/>
				<select name="country" id="country"></div>
			...
			<table>
				<thead>
					<tr class="container">
						...
						<th width="16"></th>
						<th width="16">Ime</th>
						<th width="16">Prezime</th>
						<th width="16">E mail</th>
						<th width="16">Država</th>
						<th width="16">Archive</th>
					</tr>
				</thead>
				<tbody>';
				$query  = "SELECT * FROM users";
				...
				while($row = @mysqli_fetch_array($result)) {
					...
					<tr>
						...
						<td>';
							if ($row['archive'] == 'Y') { print 'Yes'; }
                            else if ($row['archive'] == 'N') { print 'No'; }
						print '
						</td>
					</tr>';
				}
